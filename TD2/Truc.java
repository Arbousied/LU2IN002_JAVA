public class Truc {
    ...
    public void maMethode(double d1, double d2) {
        System.out.println(" je passe dans : maMethode ( double d1 , double d2 )");
    }
    public void maMethode(int i1, int i2, int i3) {
        System.out.println(" je passe dans : maMethode ( int i1 , int i2 , int i3 )");
    }
}
